...
public interface ReviewRepository extends JpaRepository<Review, Long> {
    ...
    Page<Review> findByFilters(@org.springframework.data.repository.query.Param("status") com.example.autoreview.domain.ReviewStatus status, @org.springframework.data.repository.query.Param("brand") String brand, @org.springframework.data.repository.query.Param("fuelType") String fuelType, @org.springframework.data.repository.query.Param("priceSegment") String priceSegment, Pageable pageable);
    ...
    Page<Review> findByStatus(com.example.autoreview.domain.ReviewStatus status, Pageable pageable);
